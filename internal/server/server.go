...
// to a store yet.
func New(database *sql.DB, prompts db.PromptStore, swipes db.SwipeStore, dashboard db.DashboardStore, eventHandlers db.EventHandlerStore, chains db.ChainStore) *Server {
	s := &Server{
		db:            database,
		prompts:       prompts,
		swipes:        swipes,
