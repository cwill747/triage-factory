...
- `docs/multi-tenant-architecture.html` — the full multi-tenant design (RLS, Vault, gVisor, the v1/v2/v3 scope).
- `docs/self-host-setup.md` — operator install flow for a Tier 3 self-hosted deployment.
